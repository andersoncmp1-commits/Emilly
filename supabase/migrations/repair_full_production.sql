-- RODE ESTE SCRIPT COMPLETO NO SUPABASE
-- Ele corrige a tabela 'modules' (adicionando colunas faltantes) e restaura o conteúdo.
...
BEGIN
    ...
    -- 2.2 IDENTIFICAR OU CRIAR MÓDULOS
    -- Como se portar
